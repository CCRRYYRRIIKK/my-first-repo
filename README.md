...
> [!NOTE]
> Ищу учебную практику, ментора или команду, где можно расти в системном программировании, разработке инструментов и низкоуровневой оптимизации.
...
| **Оптимизация \| Кэш, SIMD** | Уверенно в теории, практикую | анализ горячих циклов, `perf stat` |
...
- Выход из режима вставки в Vim: ESC
- Сохранить и выйти: :x
- Начало / конец файла: gg / G
- Отмена: u
- Повтор действия: Ctrl + R
- Прервать процесс в терминале: Ctrl + C
